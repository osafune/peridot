...
//#define na_VRAM_size		(1024*272*2)
#define na_VRAM_size		(512*96*2)
//#define na_VRAM_linewidth	(11)
#define na_VRAM_linewidth	(10)
#define na_VRAM_linesize	(1<<na_VRAM_linewidth)

#define draw_base			(0)
//#define window_xsize		(480)
#define window_xsize		(400)
#//define window_ysize		(272)
#define window_ysize		(96)
